...
import 'control_recomendation.dart';
import 'signin.dart';
...
class _SignUpEmailState extends State<SignUpEmail> {
  ...
  void _simulateSignUp() {
    ...
    if (name.isEmpty && email.isEmpty && password.isEmpty) {
      error = 'Fill in your full name, email and password.';
          ...
          return SizedBox(
            ...
            child: Stack(
              ...
              children: [
                ...
                // "Already have an account? Sign In" (x=84, y=774)
                Positioned(
    ...
    return Column(
      ...
      children: [
        ...
        if (widget.error) ...[
          const SizedBox(height: 10),
          const Text(
            'It\'s weak! Enter a combination of numbers, words &...',
            style: TextStyle(
              color: Color(0xFFFF4C61),
              fontSize: 10,
              fontFamily: 'Inter',
    ...
    return SizedBox(
      ...
      child: Row(
        ...
        children: [
          ...
          const Expanded(
            child: Text(
              'I agree with Movietime Terms of Service, Privacy Policy, and default Notification Settings.',
              style: TextStyle(
                color: Color(0xFF9E9E9E),
                fontSize: 10,
                fontFamily: 'Inter',
