...
import { DEFAULT_MAX_CAROUSEL_ITEMS } from '@/lib/carouselConfig';
...
interface BaseCarouselProps {
  ...
  /** Maximum number of child items to render (helps performance on weak devices). */
      ...
      <div className={cn("relative", containerClassName)}>
        ...
        >
          {(() => {
            ...
            const max = typeof maxItemsLoaded === 'number' ? maxItemsLoaded : DEFAULT_MAX_CAROUSEL_ITEMS;
            return childs.slice(0, max);
          })()}
        </div>
      </div>
    </motion.section>
