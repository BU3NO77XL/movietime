...
export async function generateMetadata(
    ...
    const fallback: Metadata = {
        title: 'Assistir - Legacy Mov',
        description: 'Assista online com qualidade no Legacy Mov.',
        other: {
            'og:video': embedUrl,
    ...
    try {
        ...
        const description = data?.overview || `Assista ${title} online com qualidade no Legacy Mov.`;
