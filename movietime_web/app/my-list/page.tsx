...
export default function MyList() {
    ...
    const { data: watchlistData = emptyItems, isFetched: watchlistFetched } = useQuery({
                        ...
                        >
                            {searchQuery ? (
                                <>
                                    ...
                                    <button
                                        onClick={() => setSearchQuery('')}
                                        className="bg-white/10 hover:bg-white/20 text-white font-semibold rounded-md px-8 py-3 transition-all"
                                    >
                                        Limpar busca
                                    </button>
                                </>
                                ...
                                <>
                                    ...
                                    <button
                                        onClick={() => router.push('/')}
                                        className="bg-[#1DB954] hover:bg-[#1ed760] text-black font-semibold rounded-md px-8 py-3"
                                    >
                                        Browse Content
                                    </button>
                                </>
