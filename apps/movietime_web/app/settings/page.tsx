    ...
    >
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-8 sm:py-12 pt-24 sm:pt-28">
              ...
              {editingName ? (
                <div className="relative">
                  <div className="flex justify-end gap-2 mb-3">
                    <button onClick={handleSaveName} disabled={savingName} className="bg-white hover:bg-white/80 text-black px-4 py-2 rounded-md font-medium transition-colors disabled:opacity-50 text-sm">
                      {savingName ? 'Salvando...' : 'Salvar'}
                    </button>
                    <button onClick={() => { setEditingName(false); setNameInput(userName); }} className="bg-white/10 hover:bg-white/20 text-white px-4 py-2 rounded-md transition-colors text-sm">
                      Cancelar
                    </button>
                  </div>
        ...
        <button
          ...
          className="w-full bg-white hover:bg-white/80 text-black font-bold py-3.5 rounded-lg transition-colors disabled:opacity-50 mb-10"
        >
