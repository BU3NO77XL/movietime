  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-md px-6 mt-12 mb-12">
        <div
          className="bg-black/90 border border-white/10 rounded shadow-2xl backdrop-blur-md overflow-hidden p-8"
        >
          <div className="flex flex-col items-center mb-8">
            <div className="flex items-center gap-2.5 mb-2">
              ...
              */}
              <h1
                className="text-2xl sm:text-3xl leading-none whitespace-nowrap"
                style={{
              ...
              >
                <span className="text-white">Legacy Mov</span>
              </h1>
            </div>
          </div>
          ...
          {!isSignup && (
            <form onSubmit={handleLogin} className="space-y-5">
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full bg-white hover:bg-gray-100 disabled:bg-white/50 disabled:cursor-not-allowed text-black font-bold py-3.5 rounded-lg flex items-center justify-center gap-2 transition-all transform active:scale-[0.98]"
              >
                {isLoading ? (
              ...
              <div className="mt-6 space-y-3">
                <div className="relative">
                  ...
                  <div className="relative flex justify-center text-sm">
                    <span className="px-2 bg-transparent text-gray-500">Ou entre com</span>
                  </div>
                </div>

              <div className="flex gap-3 pt-2">
                  <button type="button" onClick={() => toast.error('Login social não disponível.')} className="flex-1 flex items-center justify-center gap-2 py-3 px-4 bg-white/10 hover:bg-white/20 rounded-lg border border-white/10 transition-all">
        ...
        <div className="mt-6 text-center">
          <p className="text-xs mb-2" style={{ color: '#888' }}>
            © 2025 Legacy Mov Entertainment Inc.
          </p>
